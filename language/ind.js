...
${a}❏GROUP MENU${a}
 ${a}│•${prefix}Eliminar${a}
 ${a}│•${prefix}hidetag${a}
 ${a}│•${prefix}Listadebloqueados${a}
 ${a}│•${prefix}listagrupo${a}
 ${a}│•${prefix}nivel${a}
 ${a}│•${prefix}linkgc${a}
 ${a}│•${prefix}mencionartodos${a}
 ${a}│•${prefix}setpp${a}
 ${a}│•${prefix}agregar${a}
 ${a}│•${prefix}Sacar${a}
 ${a}│•${prefix}setname${a}
...
${a}❏OWNER MENU${a}
 ...
 ${a}│•${prefix}bcgc${a}
 ${a}│•${prefix}eliminaratodos${a}
 ${a}│•${prefix}setreply${a}
 ${a}│•${prefix}setprefix${a}
 ${a}│•${prefix}limpiartodo${a}
 ${a}│•${prefix}bloquear${a}
 ${a}│•${prefix}desbloquear${a}
 ${a}│•${prefix}leave${a}
 ${a}│•${prefix}evento [1/0]${a}
 ${a}│•${prefix}clonar${a}
 ${a}╰•${prefix}setppbot${a}
...
${a}❏THANKS TO${a}
 ...
 ${a}│ • Sunao bot uwu
 ${a}│${a}
 ${a}╰ • NOTE : no enviar muchos comandos en un rato xd
